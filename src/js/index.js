function formWarga() {
  window.location.href = "http://127.0.0.1:5500/public/formWarga.html";
}

// SlideShow Dibawah ini
...
function menu() {
  if (document.documentElement.scrollTop > 100) {
    ...
    document.getElementById("header").classList.add("dar");
...
info.addEventListener("onscroll", function () {
  if (document.documentElement.scrollTop > 10000) {
    document.getElementById("infoo").classList.add("bg-slate-300");
    document.getElementById("infoo").classList.remove("hidden");
  } else {
    document.getElementById("infoo").classList.remove("bg-slate-300");
  }
...
const blom = document.querySelector("#blom");
blom.addEventListener("click", function () {
