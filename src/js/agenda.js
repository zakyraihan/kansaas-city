function Menu(e) {
  ...
  //     document.getElementById("header").classList.add("dark:bg-slate-400");
  //   } else {
  //     document.getElementById("header").classList.remove("bg-white");
  //     document.getElementById("header").classList.remove("shadow-lg");
  //     document.getElementById("header").classList.remove("dark:bg-slate-400");
  //   }
  // }
  ...
  function agenda(e) {
    e.classList.add('hover:scale-110')
  }
